...
#    load taxonomy data
    ...
    # print('{} {}: Load kraken2 results'.format(timestamp(), sample))
    # r2c_kraken=import_kraken_results(sample_folder +
    #                       'kraken2/marine{}.kraken2.small.out'.format(sample),
    #                       taxid2parent, taxid2rank)
    # print('{} {}: Comparing kraken2 results to CAMI'.format(timestamp(), sample))
    # correct=compare_results(CAMI_r2c, r2c_kraken, total_reads)
    # correct['total_reads']=total_reads
    ...
    print('{} load CAMI classification {}'.format(timestamp(),path_to_cami+'plant/simulation_short_read/'
    ...
    with open('/net/phage/linuxhome/mgx/people/tina/RAT/revision/'
              'read_classifiers_new_db_plant/results/r2c_unknowns_plant_centrifuge_ncbi{}.json'
              ''.format(sample), 'w+') as outf:
        outf.write(json.dumps(correct, indent=4))
    del r2c_centrifuge
    ...
    correct['total_reads']=total_reads
    with open('/net/phage/linuxhome/mgx/people/tina/RAT/revision/'
              'read_classifiers_new_db_plant/results/r2c_unknowns_plant_kaiju_ncbi{}.json'
              ''.format(sample), 'w+') as outf:
        outf.write(json.dumps(correct, indent=4))
    del r2c_kaiju
    ...
    correct['total_reads']=total_reads
    with open('/net/phage/linuxhome/mgx/people/tina/RAT/revision/'
              'read_classifiers_new_db_plant/results/r2c_unknowns_plant_kraken_ncbi{}.json'
              ''.format(sample), 'w+') as outf:
        outf.write(json.dumps(correct, indent=4))
